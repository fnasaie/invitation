...
import com.naqi.invitation.filter.SessionRequestFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  @Bean
  public SessionRequestFilter authenticationJwtTokenFilter() {
  ...
  public CorsFilter corsFilter() {
    ...
    config.addAllowedOriginPattern("*"); // Update to use allowedOriginPatterns
